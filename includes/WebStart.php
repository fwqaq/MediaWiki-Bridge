...
// MindTouch (steveb): check if a 'site' argument is passed in with the request
if(isset($_POST['site'])) $wgSitename = urldecode($_POST['site']);
// MindTouch: --- end

// MindTouch (steveb): check if a 'lang' argument is passed in with the request
if(isset($_POST['lang'])) $wgLanguageCode = $_POST['lang'];
// MindTouch: --- end

// MindTouch (steveb): initialize interwiki array
$wgInterwikiList = array();
// MindTouch: --- end
